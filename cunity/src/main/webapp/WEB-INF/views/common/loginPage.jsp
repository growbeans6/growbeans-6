              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <div class="custom-control custom-checkbox small">
                    ...
                    <input type="radio" name="chk_info" onchange ="setDisplay()" id="student" checked>Stduent
                    &nbsp;&nbsp;
                    <input type="radio" name="chk_info" onchange ="setDisplay()" id="Professor">Professor   
                </div>    
                  
                  <form class="student" id="student1" action="#">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="studentId" placeholder="Student Id" name="studentId">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="studentPassword" placeholder="Password" name="studentPassword">
                    </div>
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
