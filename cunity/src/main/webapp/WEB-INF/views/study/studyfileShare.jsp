									...
									<div class="card w-75">
										<div class="card-body">
											<form action="sfinsert.cunity" method="post" id="fileForm"
												...
												<input type="hidden" name="folderNo" value="${childerenFolderList[1].folderNo }">
													<label for="exampleFormControlInput1">글 제목</label> <input
														type="text" class="form-control"
														id="exampleFormControlInput1" name="fileName"
														placeholder="파일명이 들어가는 부분입니다." disabled="disabled">
												</div>
												<div class="form-group">
