				...
				<div class="container-fluid">
					...
					<div class="content">
						...
						<div id="content-layer1" class="col-lg-8">
							...
							<div
								style="position: fixed; top: 110px; left: 430px; z-index: 3;">
								<a href="javascript:void(0);" onclick="toggleMenu();"><h4>
										<i class="fas fa-bars"></i>
									</h4></a>
								<div id="toggleArea" class="card "
									style="display: none;">
									<h5>
									<c:url var="deleteFolder" value="/deleteFolder.cunity">
										<c:param name="folderNo" value="${studyFolder.folderNo }"/>
									</c:url>
										<a href="${deleteFolder }">폴더삭제</a>
